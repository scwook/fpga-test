...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {COUNT_SIG_0}];  # "JA1"
set_property PACKAGE_PIN AA11 [get_ports {TRIGGER_SIG_0}];  # "JA2"
#set_property PACKAGE_PIN Y10  [get_ports {JA3}];  # "JA3"
#set_property PACKAGE_PIN AA9  [get_ports {spi_clock_0}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {PASS_COUNT_0}];  # "JA7"
set_property PACKAGE_PIN AB10 [get_ports {PASS_TRIGGER_0}];  # "JA8"
set_property PACKAGE_PIN AB9  [get_ports {PASS_GATE_0}];  # "JA9"
#set_property PACKAGE_PIN AA8  [get_ports {JA10}];  # "JA10"

set_property PULLDOWN true [get_ports {COUNT_SIG_0}];
set_property PULLDOWN true [get_ports {TRIGGER_SIG_0}];
set_property PULLDOWN true [get_ports {PASS_COUNT_0}];
set_property PULLDOWN true [get_ports {PASS_TRIGGER_0}];
set_property PULLDOWN true [get_ports {PASS_GATE_0}];

# ----------------------------------------------------------------------------
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {spi_sync_0}];  # "JB1"
set_property PACKAGE_PIN W11 [get_ports {spi_data_0}];  # "JB2"
#set_property PACKAGE_PIN V10 [get_ports {JB3}];  # "JB3"
set_property PACKAGE_PIN W8 [get_ports {spi_clock_0}];  # "JB4"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN U10  [get_ports {oled_dc_n_0}];  # "OLED-DC"
set_property PACKAGE_PIN U9   [get_ports {oled_reset_n_0}];  # "OLED-RES"
set_property PACKAGE_PIN AB12 [get_ports {oled_spi_clk_0}];  # "OLED-SCLK"
set_property PACKAGE_PIN AA12 [get_ports {oled_spi_data_0}];  # "OLED-SDIN"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {CONFIG_DATA_0[0]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {CONFIG_DATA_0[1]}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {CONFIG_DATA_0[2]}];  # "LD2"
#set_property PACKAGE_PIN U21 [get_ports {CONFIG_DATA_0[3]}];  # "LD3"
#set_property PACKAGE_PIN V22 [get_ports {CONFIG_DATA_0[4]}];  # "LD4"
#set_property PACKAGE_PIN W22 [get_ports {CONFIG_DATA_0[5]}];  # "LD5"
#set_property PACKAGE_PIN U19 [get_ports {CONFIG_DATA_0[6]}];  # "LD6"
#set_property PACKAGE_PIN U14 [get_ports {CONFIG_DATA_0[7]}];  # "LD7"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {RESET_BTN_0}];  # "BTNC"
set_property PACKAGE_PIN R16 [get_ports {RESET_BTN_1}];  # "BTND"
set_property PACKAGE_PIN N15 [get_ports {RESET_BTN_2}];  # "BTNL"
...
## ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN F22 [get_ports {en_trigger_0}];  # "SW0"
