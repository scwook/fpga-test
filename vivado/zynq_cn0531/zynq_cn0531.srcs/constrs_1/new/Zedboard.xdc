...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {spi_sync_0}];  # "JA1"
set_property PACKAGE_PIN AA11 [get_ports {spi_data_0}];  # "JA2"
...
#set_property PACKAGE_PIN U14 [get_ports {tag_0}];  # "LD7"
...
#set_property PACKAGE_PIN N15 [get_ports {lbtn_0}];  # "BTNL"
