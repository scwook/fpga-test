...
# ----------------------------------------------------------------------------
#set_property PACKAGE_PIN P16 [get_ports {reset_0}];  # "BTNC"
...
#set_property IOSTANDARD LVCMOS25 [get_ports lbtn_0]
#set_property IOSTANDARD LVCMOS25 [get_ports rbtn_0]
#set_property IOSTANDARD LVCMOS25 [get_ports CNT]
