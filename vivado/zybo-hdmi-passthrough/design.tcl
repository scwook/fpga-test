...
proc create_root_design { parentCell } {
  ...
  set TMDS_IN_DDC [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 TMDS_IN_DDC ]


  # Create ports
  set sys_clock [ create_bd_port -dir I -type clk -freq_hz 125000000 sys_clock ]
  set reset_rtl [ create_bd_port -dir I reset_rtl ]
  set TMDS_IN_HPD [ create_bd_port -dir O -from 0 -to 0 TMDS_IN_HPD ]
  set pLocked_0 [ create_bd_port -dir O pLocked_0 ]
  set aLocked_0 [ create_bd_port -dir O aLocked_0 ]

  # Create instance: rgb2dvi_0, and set properties
  set rgb2dvi_0 [ create_bd_cell -type ip -vlnv digilentinc.com:ip:rgb2dvi:1.4 rgb2dvi_0 ]
  set_property CONFIG.kClkRange {1} $rgb2dvi_0
  ...
  connect_bd_intf_net -intf_net dvi2rgb_0_DDC [get_bd_intf_ports TMDS_IN_DDC] [get_bd_intf_pins dvi2rgb_0/DDC]
  ...
  connect_bd_net -net clk_in1_0_1  [get_bd_ports sys_clock] \
  ...
  [get_bd_ports aLocked_0]
  connect_bd_net -net dvi2rgb_0_pLocked  [get_bd_pins dvi2rgb_0/pLocked] \
  [get_bd_ports pLocked_0]
  connect_bd_net -net proc_sys_reset_0_mb_reset  [get_bd_ports reset_rtl] \
